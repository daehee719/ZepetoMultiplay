...
//		_SpecGlossMap("SpecGlossMap", 2D) = "white" {}
        ...
        [ToggleOff(COLORGRADING_OFF)]_ColorGrading("Color Grading", Float) = 0
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Standard fullforwardshadows vertex:vert finalcolor:tonemapping
		#pragma target 3.0		
		...
		CGPROGRAM
		#pragma surface surf Standard keepalpha fullforwardshadows vertex:vert finalcolor:tonemapping
		#pragma target 3.0
